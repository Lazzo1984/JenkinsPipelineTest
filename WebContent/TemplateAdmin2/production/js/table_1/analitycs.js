...
function analitycs()
	{
		...
		for(x=0;x<l2;x++)
		{
			...
			/*
			var pie_table = '<table class="table table-bordered"><thead><tr><th style="background-color:red;color:white;">High</th></tr></thead><tbody>';
			...
			*/
			...
			var html = '<table class="table table-bordered"><thead><tr><th>Issues Owasp</th><th>Quantity</th><th>Severity</th><th>Products affected by issues</th></tr></thead><tbody>';
			
			for(y=0;y<l2;y++)
			{	
				if(anal[y].Count !== 0)
				{html += "<tr><td>" + anal[y].Name + "</td>" + "<td>" + anal[y].Count + "</td>";
				if(anal[y].Cod == "3"){html += '<td style="background-color:red;">' + "<b style='color:white;'>High</b>" + '</td>';}
				else if(anal[y].Cod == "2"){html += '<td style="background-color:#f47141;">' + "<b style='color:#ffffff;'>Medium</b>" + '</td>';}
				else if(anal[y].Cod == "1"){html += '<td style="background-color:#f4d941;">' + "<b style='color:#ffffff;'>Low</b>" + '</td>';}
				else if(anal[y].Cod == "0"){html += '<td style="background-color:#41dcf4;">' + "<b style='color:#ffffff;'>Info</b>" + '</td>';}
