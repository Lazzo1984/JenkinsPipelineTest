...
function analitycs()
	{
		...
		for(x=0;x<l2;x++)
		{
			...
			var html = '<table class="table table-bordered"><thead><tr><th>Issues (Owasp143)</th><th>Quantity</th><th>Severity</th><th>Products affected by issues</th></tr></thead><tbody>';
        ...
        title: {
            text: 'VAPT GENERAL OVERVIEW : ' + '<b>' +sum + '</b>' + ' Products tested' + '<br>' + 'Period 07/07/2016 - ' + today
        },
        tooltip: {
